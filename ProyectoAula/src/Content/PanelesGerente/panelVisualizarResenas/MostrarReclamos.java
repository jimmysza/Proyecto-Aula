...
public class MostrarReclamos extends javax.swing.JPanel {
    
    String barra = File.separator;
    String ubicacion = System.getProperty("user.dir") + barra + "PQR" + barra + "Reclamos" + barra;
    ...
    private void inicializarModeloTabla() {
        ...
        dtm = new DefaultTableModel(new Object[]{"Nombre","","Reclamos"}, 0);

...
public class DiagnosticosMesero extends javax.swing.JPanel {

    private final ReservacionesModel modeloReservacion = ReservacionesModel.getInstance();
    String barra = File.separator;
    String ubicacion = System.getProperty("user.dir") + barra + "Diagnostico" + barra + "DiagnosticoMesero" + barra;
    
    
    public void crear() {
        
        String nombre = modeloReservacion.getLastUsuario();
        String archivo = nombre + ".Mesero"; 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Diagnostico - Mesero");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setText("¿Cómo realizar el proceso para llevar un plato a una mesa?:");

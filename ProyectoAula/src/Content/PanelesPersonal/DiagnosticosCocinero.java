 ...
 */
public class DiagnosticosCocinero extends javax.swing.JPanel {

    private final ReservacionesModel modeloReservacion = ReservacionesModel.getInstance();
    String barra = File.separator;
    String ubicacion = System.getProperty("user.dir") + barra + "Diagnostico" + barra + "DiagnosticoCocinero" + barra;
    
    
    public void crear() {
        
        String nombre = modeloReservacion.getLastUsuario();
        String archivo = nombre + ".Cocinero"; 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Diagnostico - Cocinero");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setText("¿Cómo son las medidas de bioseguridad?");

...
public class MostrarQuejas extends javax.swing.JPanel {

    String barra = File.separator;
    String ubicacion = System.getProperty("user.dir") + barra + "PQR" + barra + "Quejas" + barra;
    ...
    private void inicializarModeloTabla() {
        ...
        dtm = new DefaultTableModel(new Object[]{"Nombre", "file" , "Quejas"}, 0);
